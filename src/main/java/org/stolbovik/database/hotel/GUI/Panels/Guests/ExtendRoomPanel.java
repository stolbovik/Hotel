...
import org.stolbovik.database.hotel.GUI.Listeners.GuestListeners.ExtendRoomListener;
...
public class ExtendRoomPanel extends JPanel {
    ...
    private void setComponentOnFrame() {
        ...
        request.addActionListener(new ExtendRoomListener(info, roomField, newDataEndField, priceField));
